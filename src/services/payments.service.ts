...
export const paymentsService = {
  // Billing is per-project and monthly-only: the project (not the user) becomes Pro. Only the
  // project admin may start checkout; the backend returns 402/403/404/409 on errors.
  createCheckoutSession(projectId: number): Promise<CreateCheckoutSessionResponse> {
